...
if (isset($_GET['action']) && $_GET['action'] == "add") {
    ...
    if (isset($_SESSION['cart'][$id])) {
        ...
        // echo
        // "<h1>console.log(Mysqli_num_rows($query_p))</h1>";
                                ...
                                <div class="row">
                                    ...
                                    <div class="hidden-md col-sm-4 col-lg-4">
                                        <div class="info-box">
                                            ...
                                            <h6 class="text">free ship-on oder over 1.000 VNĐ</h6>
                                        </div>
                                    </div><!-- .col -->
                                            ...
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    ...
                                                    <div class="product-price">
                                                        ...
                                                        <span
                                                            class="price-before-discount">VNĐ.<?php echo htmlentities($row['productPriceBeforeDiscount']); ?>
                                                        </span>
