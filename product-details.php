...
<head>
    ...
    <meta name="keywred !important;" content="MediaCenter, Template, eCommerce">
    ...
    <link rel="shortcut icon" href="https://img.icons8.com/?size=100&id=UeZfCvGx320E&format=png&color=000000">
</head>
                                        ...
                                        <div class="products" style="padding: 8px;">
                                            ...
                                            <div class="product-info text-left m-t-20">
                                                ...
                                                <div class="product-price">
                                                    <span class="price">
                                                        VNĐ. <?php echo htmlentities($rws['productPrice']); ?>.00
                                                    </span>
                                            ...
                                            <div class="cart clearfix animate-effect">
                                                <div class="action">
                                                    ...
                                                    <div class="add-cart-button btn-group">
                                                        ...
                                                        <?php } else { ?>
                                                            <div class="action" style="color:#3498db;">
                                                                Out of Stock</div>
                                                        <?php } ?>
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="price-container info-container m-t-20">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="price-box">
                                                    <span class="price">VNĐ.
                                                        <?php echo htmlentities($row['productPrice']); ?></span>
                                                    <span
                                                        class="price-strike">VNĐ.<?php echo htmlentities($row['productPriceBeforeDiscount']); ?></span>
                                                </div>
                                            </div>
