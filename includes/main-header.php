                            ...
                            <div class="cart-item product-summary">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        ...
                                        <div class="price">
                                            VNĐ.<?php echo ($row['productPrice'] + $row['shippingCharge']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?>
                                        </div>
                                    </div>
                            ...
                            <div class="clearfix cart-total">
                                <div class="pull-right">
                                    ...
                                    <span class="text">Total :</span><span
                                        class='price'>VNĐ.<?php echo $_SESSION['tp'] = "$totalprice" . ".00"; ?></span>
                    ...
                    <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
                        <div class="items-cart-inner">
                            ...
                            <div class="basket-item-count"
                                style="background-color: #3498db; display: flex; justify-content: center; align-items: center">
